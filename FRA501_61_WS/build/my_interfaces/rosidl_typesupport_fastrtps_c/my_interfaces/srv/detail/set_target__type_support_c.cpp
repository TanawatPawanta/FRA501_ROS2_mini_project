...
#include "my_interfaces/srv/detail/set_target__rosidl_typesupport_fastrtps_c.h"
...
using _SetTarget_Request__ros_msg_type = my_interfaces__srv__SetTarget_Request;
...
size_t get_serialized_size_my_interfaces__srv__SetTarget_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetTarget_Request__ros_msg_type * ros_message = static_cast<const _SetTarget_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SetTarget_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_interfaces__srv__SetTarget_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_interfaces
size_t max_serialized_size_my_interfaces__srv__SetTarget_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _SetTarget_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_interfaces__srv__SetTarget_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_interfaces, srv, SetTarget_Request)() {
...
using _SetTarget_Response__ros_msg_type = my_interfaces__srv__SetTarget_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_interfaces
size_t get_serialized_size_my_interfaces__srv__SetTarget_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetTarget_Response__ros_msg_type * ros_message = static_cast<const _SetTarget_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_interfaces__srv__SetTarget_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_interfaces
size_t max_serialized_size_my_interfaces__srv__SetTarget_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _SetTarget_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_interfaces__srv__SetTarget_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_interfaces, srv, SetTarget_Response)() {
...
// already included above
// #include "my_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "my_interfaces/srv/set_target.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_interfaces, srv, SetTarget)() {
